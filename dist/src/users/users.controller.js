...
__decorate([
    (0, common_1.Post)(),
    (0, roles_decorator_1.Roles)(client_1.Role.ADMIN),
    (0, common_1.UsePipes)(new nestjs_zod_1.ZodValidationPipe(create_user_dto_1.CreateUserDto)),
...
__decorate([
    (0, common_1.Put)(':id'),
    (0, roles_decorator_1.Roles)(client_1.Role.ADMIN),
    (0, common_1.UsePipes)(new nestjs_zod_1.ZodValidationPipe(update_user_dto_1.UpdateUserDto)),
    __param(0, (0, common_1.Param)('id')),
